...
cap.set(cv2.CAP_PROP_FRAME_WIDTH, 1280) # Image width in pixels
cap.set(cv2.CAP_PROP_FRAME_HEIGHT, 720)  # Image height in pixels
...
while True:
    ...
    sigma = 0.5 # Auto threshold setting parameter
    v = np.median(gray) * 0.3
    ...
    c = cv2.waitKey(20) # Loop every 10 ms. If timeout, return val is -1.
